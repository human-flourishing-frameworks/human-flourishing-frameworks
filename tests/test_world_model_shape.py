...
class WorldModelShapeTest(unittest.TestCase):
    ...
    def test_flourishing_defaults_are_small_component_dicts(self):
        ...
        self.assertEqual(set(components["humans"].keys()), {"health", "autonomy", "fairness", "opportunity"})
        self.assertEqual(set(components["animals"].keys()), {"health", "safety", "comfort", "natural_behavior"})
        self.assertEqual(set(components["ecosystems"].keys()), {"biodiversity", "stability", "resilience"})
