...
if __name__ == '__main__':
    ...
    print("="*80)
    print("\n✓ Dashboard loaded with live violation data")
    ...
    print("  - 📋 Audits (retroactive verification)")
    print("  - 🗳️ Board Voting (democratic decisions)")
    print("  - 📍 Deployments (active systems)")
